            ...
            <div className="container mx-auto px-6 py-4 flex items-center justify-between">
                ...
                {!isRegistered && (
                    <div className="flex items-center gap-4">
                        ...
                        <button onClick={() => navigate(`/checkout/course/${course.id}`)} className="bg-primary text-white px-6 py-2 rounded-full font-bold shadow-lg hover:shadow-xl hover:bg-green-600 transition-all transform hover:-translate-y-1">
                            Đăng ký ngay
                        </button>
                    </div>
                )}
