...
const FilterBar = ({ filters, activeFilter, onFilterChange, onToggleAdvanced, isAdvancedOpen }) => {
    return (
        <div className="relative flex flex-col md:flex-row items-center justify-between mb-8 gap-4 md:gap-0 min-h-[60px]">
            ...
            <div className="z-0 md:absolute md:left-1/2 md:top-1/2 md:-translate-x-1/2 md:-translate-y-1/2">
                <div className="flex p-1.5 bg-white/90 backdrop-blur-xl border-2 border-primary rounded-full shadow-xl shadow-primary/10">
                    {filters.map((label) => {
                        ...
                        return (
                            <button
                                ...
                                className="relative px-6 py-2 rounded-full text-sm font-bold transition-all duration-300 outline-none min-w-[100px]"
                            >
                                {isActive && (
                                    <motion.div
