        ...
        <div className="space-y-1">
            ...
            <div className="relative group">
                ...
                <input
                    ...
                    value={value}
                    onChange={onChange}
                    className={`w-full ${Icon ? 'pl-9' : 'pl-3'} pr-3 ${inputPadding} text-sm bg-slate-50 border border-slate-200 rounded-lg focus:bg-white focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/10 outline-none transition-all placeholder:text-slate-400 font-medium text-slate-700`}
